            ...
            children: <Widget>[
                ...
                GridView.count(
                  ...
                  children: <Widget>[
                    GestureDetector(
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => MyContracts(mycontracts: mycontracts,),));
                      },
                                          child: Padding(
                      ...
                      BoxShadow(
                        ...
                        blurRadius: 6.0,
                            ...
                            child: Column(
                              ...
                              children: <Widget> [
                                Text(mycontracts.length.toString(), style: TextStyle(
                                  color: Colors.white,),
                    ...
                    Padding(
                        ...
                        child: GestureDetector(
                          onTap: () {
                            Navigator.push(context, MaterialPageRoute(builder: (context) => PendingTransaction(pendingcontracts: pendingcontracts,),)).then((value) => getcontracts());
                          },
                          child: Container(
                            padding: EdgeInsets.all(8),
                            decoration: BoxDecoration(
                    ...
                    BoxShadow(
                      ...
                      blurRadius: 6.0,
                            ...
                            child: Column(
                              ...
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: <Widget> [
                                Text(pendingcontracts.length.toString(), style: TextStyle(
                                  color: Colors.white,
                                ),),
                    ...
                    Padding(
                        ...
                        child: GestureDetector(
                          onTap: () {
                            Navigator.push(context, MaterialPageRoute(builder: (context) => InProgressTransaction(inprogresscontracts: ongoingcontracts,),));
                          },
                          child: Container(
                            padding: EdgeInsets.all(8),
                            height: 70,
                    ...
                    BoxShadow(
                      ...
                      blurRadius: 6.0,
                            ...
                            child: Column(
                              ...
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: <Widget> [
                                Text(ongoingcontracts.length.toString(), style: TextStyle(
                                  color: Colors.white,
                                ),),
                    ...
                    GestureDetector(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context) => CompletedTransaction(completedcontracts: completedcontracts,),));
                      },
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: <Widget> [
                                Text(completedcontracts.length.toString(), style: TextStyle(
                                  color: Colors.white,
                                ),),
                    ...
                    GestureDetector(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context) => CanceledTransaction(canceledcontracts: canceledcontracts,),));
                      },
                                        child: Padding(
                          padding: const EdgeInsets.all(5.0),
                          child: Container(
                            ...
                            child: Column(
                              ...
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: <Widget> [
                                Text(canceledcontracts.length.toString(), style: TextStyle(
                                  color: Colors.white,
                                ),),
                                Text("OBJECTION OR FAILURE", style: TextStyle(
                                 fontSize: 16,
                                 color: Colors.white
                                ),)
                              ]
