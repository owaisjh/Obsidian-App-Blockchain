                            ...
                            children: <Widget>[
                              Container(
                                ...
                                child: ListTile(
                                  ...
                                  title: Text('By : ${mycontracts[index]['employerEmail']}', 
                                 style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)
                                  ...
                                  subtitle: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        mycontracts[index]['contractAddress'].isEmpty ? Container() :
                                          Text('Contract Address: ${mycontracts[index]['contractAddress']}'),
                                          
                                        
                                        
                                        Text('Duration: ${mycontracts[index]['duration']} days'),
                                        Text('Hourly Rate: Rs ${mycontracts[index]['hourRate']}'),
                                        Text('Leaves Allowed: ${mycontracts[index]['leavesAllowed']}'),
                                        Text('Early Bonus: ${mycontracts[index]['earlyBonus']}% per day'),
                                        Text('Overdue Charge: ${mycontracts[index]['overdueCharge']}% per day'),
                                      ...
                                      child: RaisedButton(
                                          ...
                                          showDialog( 
                                            ...
                                            builder: (BuildContext context) { 
                                              return Container(
                                                child: AlertDialog( 
                                                  title: Text('Please Fill In these '), 
                                                  content: 
                                                    Form(
                                                    autovalidate:true,
                                                  child: Column(
                                                    children: <Widget>[
                                                      ...
                                                      TextFormField(
                                                        decoration: InputDecoration(
                                                            labelText: "Enter no of Leaves taken", 
                                                            fillColor: Colors.white,
                                                            //prefixIcon: Icon(Icons.email)
                                                            ),
                                                  ...
                                                  actions: [ 
                                                    ...
                                                    FlatButton( 
                                                      ...
                                                      onPressed: () async {
                                                        ...
                                                        var response = await completeContract(mycontracts[index]['id'], hoursWorked, noOfLeaves);
                                                        //Navigator.pop(context);
                                                        print("hello");
